...
namespace Orient.Client
{
    public class ODatabase : IDisposable
    {
        ...
        {
            return new OSqlTraverse(_connection).Traverse(projections);
        }

        public OSqlTraverse Traverse(OSqlTraverse.FieldSelection selection)
        {
            return new OSqlTraverse(_connection).Traverse(selection);
        }
