...
namespace SHS.Sage.Linq.Translation
{
    ...
    {
        protected RedundantSubqueryRemover()
        {
        }
        ...
        protected class RedundantSubqueryGatherer : DbExpressionVisitor
        {
            protected List<SelectExpression> redundant;

            protected RedundantSubqueryGatherer()
            {
            }
        ...
        protected class SubqueryMerger : DbExpressionVisitor
        {
