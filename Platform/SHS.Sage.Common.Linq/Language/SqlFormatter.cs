...
namespace SHS.Sage.Linq.Language
{
    ...
    public class SqlFormatter : DbExpressionVisitor
    {
        ...
        protected int depth;
        protected Dictionary<IdentifiableAlias, string> aliases;
        ...
        protected bool HideFieldAliases
        {
            get { return this.hideFieldAliases; }
            set { this.hideFieldAliases = value; }
        }

        protected bool HideIdentifiableAliases
        {
            get { return this.hideIdentifiableAliases; }
            set { this.hideIdentifiableAliases = value; }
        }
        ...
        {
            string name = (this.Language != null) ? this.Language.Quote(fieldName) : fieldName;
            this.Write(name);
        }
            ...
            else
            {
                switch (Type.GetTypeCode(value.GetType()))
                {
                    ...
                    case TypeCode.Object:
                        ...
                        {
                            this.Write(value.GetType().Name);
                            this.Write("[");
                            this.Write(string.IsNullOrEmpty(((IIdentifiable)value).Id) ? "NEW" : ((IIdentifiable)value).Id);
                            this.Write("]");
                            break;
                        }
                        else
        ...
        protected override Expression VisitSelect(SelectExpression select)
        {
            ...
            this.WriteFields(select. Fields);
            if (select.From != null)
            {
        ...
        protected virtual void WriteFields(ReadOnlyCollection< FieldDeclaration> fields)
        {
            if (fields.Count > 0)
            {
        ...
        protected override Expression VisitSource(Expression source)
        {
            ...
            switch ((DbExpressionType)source.NodeType)
            {
                case DbExpressionType.Identifiable:
                    ...
                    this.WriteIdentifiableName(table.Name);
